...
|:---:|:---:|:---:|:---:|
| java  | 0 ms | 35.9 MB | 2021/11/05 11:11 |

```java

class Solution {
    public int get_max_money(int start, int end, int[]nums){
    ...
    public int rob(int[] nums) {
        ...
        int ans = get_max_money(0, nums.length - 2, nums);
        int ans2 = get_max_money(1, nums.length - 1, nums);
